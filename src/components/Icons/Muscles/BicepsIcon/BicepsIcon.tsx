...
export const BicepsIcon = (props: SvgProps) => {
  return (
    <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      ...
      />
      <Path
        d="M15.716 10.075c-2.21-.42-4.913 1.761-4.778 1.964.136.203.724 1.539.293 2.254h3.228c1.273-.101 2.43-.428 4.307-1.322a.323.323 0 00.186-.345c-.248-1.407-1.41-2.204-3.236-2.551z"
        fill="url(#prefix__paint0_linear)"
      />
      <Path
        d="M9.931 18.041l5.03-.125c1.006-.108 1.723-.014 2.765-.88.69-.666.975-1.247 1.257-2.666.007-.076.012-.15.014-.225.01-.243-.248-.386-.467-.28-1.674.807-2.704 1.09-4.073 1.204h-3.222c.124 2.29-.48 2.598-1.304 2.972z"
        fill="#fff"
      />
      <Defs>
        <LinearGradient
