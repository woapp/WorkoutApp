...
export const EmptyData: FunctionComponent<Props> = ({ size }) => (
  <Svg data-name="Layer 1" width={size} height={size} viewBox="0 0 820.16 780.81">
    ...
    <Path
      ...
      fill="url(#prefix__c)"
    />
    <Path fill="#20CC86" d="M183.007 98.422L378.4 56.498l9.917 46.218-195.393 41.924z" />
    <Path
    ...
    <Path
      ...
      fill="url(#prefix__f)"
    />
    <Path fill="#20CC86" d="M377.02 104.56h199.84v47.27H377.02z" />
    <Path
    ...
    <Path
      ...
      opacity={0.5}
    />
    <Circle cx={812.64} cy={314.47} r={7.53} fill="#20CCC2" opacity={0.5} />
    <Circle cx={230.73} cy={746.65} r={7.53} fill="#20CCC2" opacity={0.5} />
    <Circle cx={735.31} cy={477.23} r={7.53} fill="#20CCC2" opacity={0.5} />
    <Circle cx={87.14} cy={96.35} r={7.53} fill="#20CCC2" opacity={0.5} />
    <Circle cx={7.53} cy={301.76} r={7.53} fill="#20CC86" opacity={0.5} />
  </Svg>
);
